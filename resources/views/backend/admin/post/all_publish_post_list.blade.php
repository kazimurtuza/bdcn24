                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item custom-dropdown-item"
                                                       href="{{route('admin.search.post',['id'=>$post_data->id])}}">
...
@section('js')
    ...
    <script>
        ...
        function search() {
            ...
            var colum = '';
            //src post which status 1
            var src_by_status = 1;


            $.ajax({
                url: "{{route('admin.search.post.search-list')}}",
                type: "get",
                data: {
                    src_type: srctype,
                    colum: colum,
        ...
        function srclist(data){

            var title=$(data).val();

            $.ajax({
                url: "{{route('admin.src.post.list.get')}}",
                type: "get",
                data: {
                    title:title,
                    post_status:0,
