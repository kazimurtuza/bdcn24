            ...
            <div class="card w-100 rounded-4">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-0 text-color-heading">Visitor This Month</h6>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="">
                            ...
                            <p class="mb-0 text-color-heading">Today Visitor</p>
                        </div>
                        <div class="vr"></div>
                        <div class="">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card rounded-4">
                        <div class="card-body reporter-card">
                            <div class="d-flex align-items-center overflow-reporter-box">
                                <div class="reporter-wrap">
                                    <div class="post-header today-post-area flex-wrap justify-content-between d-flex align-items-center">
                                        <div class="reporter-post margin-right">
                                            <div class="post-header-title">
                                                <p>Today's Post Counter</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="reporter-List">
                                        <div class="reporter-post-body d-flex align-items-center flex-wrap  justify-content-between">
                                            <div class="reporter-box-2 margin-right">
                                                <a href="javascript:void(0);">
                                                    <div class="reporter-item two d-flex align-items-center">
                                                        <div class="reporter-img">
                                                            <img src="{{ asset('assets/backend') }}/images/avatars/avatar-11.png" alt="">
                                                        </div>
                                                        <div class="reporter-name">
                                                            <h4>Musa karim Shuvo</h4>
                                                            <p>Editor</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="post-Counter">
                                                <p>10</p>
                                                <small><span>1200</span> - Total Post's</small>
                                            </div>
                                        </div>
                                        <div class="reporter-post-body d-flex align-items-center flex-wrap  justify-content-between">
                                            <div class="reporter-box-2 margin-right">
    ...
    <div class="row">
        <div class="col-12 col-lg-6 col-xl-6 d-flex">
            <div class="card rounded-4 w-100">
                ...
                <div class="table-responsive word-map-wrap">
        ...
        <div class="col-12 col-lg-6 col-xl-6 d-flex">
            <div class="card rounded-4 w-100">
                <div class="card-body p-2">
                    <div class="d-flex align-items-center mb-3">
                        <h6 class="mb-0 text-color-heading">Most Popular Article</h6>
                    </div>
                    <div class="most-popular-wrap custom-card-scroll">
                        <div class="d-flex align-items-center gap-3  p-card ">
                            <div class="product-box border">
                                <img src="{{ asset('assets/backend') }}/images/post/1654411238AS3FmMEN.jpg" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="mb-2"><span class="cate-post text-red">বাণিজ্য-অন্যান্য</span>
                                        <span class="ms-3 date-post-p">Jun 5, 2022</span><span class="float-end fw-bold visitor-p">4,216 <span>Visitor</span></span>
                                    </p>
                        ...
                        <div class="d-flex align-items-center gap-3  p-card ">
                            <div class="product-box border">
                                <img src="{{ asset('assets/backend') }}/images/post/1654410704WtUmoE7z.jpg" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    ...
                                    <div class="post-title-popular">
                                        <h4>কৃষিতে ভর্তুকি থেকে ধীরে ধীরে সরে আসা উচিত</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex align-items-center  gap-3 p-card ">
                            <div class="product-box border">
                                <img src="{{ asset('assets/backend') }}/images/post/1654410369xxEcOpur.jpg" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                        ...
                        <div class="d-flex align-items-center  gap-3 p-card ">
                            <div class="product-box border">
                                <img src="{{ asset('assets/backend') }}/images/post/1654409933l4ZhrQ0B.jpg" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="mb-2"><span class="cate-post text-red">স্বাস্থ্য ও পরিবে...</span> <span
                                            class="dots1"></span> <span class="ms-3 date-post-p">Jun 5, 2022</span><span class="float-end fw-bold visitor-p">4,216
                                       <span>Visitor</span></span>
                                    </p>
                                    <div class="post-title-popular">
                        ...
                        <div class="d-flex align-items-center  gap-3 p-card ">
                            <div class="product-box border">
                                <img src="{{ asset('assets/backend') }}/images/post/1654408204LIolA9P6.jpg" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
